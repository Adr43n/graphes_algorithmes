import time
import graph_algorithms as Im
# graph_algorithms  est un module contenant toutes les fonctions nécessaires pour simplifier notre travail dans cette question.
